...
$
  f(t)
  &= a_0 / 2 + ∑_(n=1)^∞ (a_n cos frac(n π, L) t + b_n sin frac(n π, L) t)\
  &= a_0 / 2 +
...
$
  ...
  ∑_(n=1)^∞ frac(a_n - i b_n, 2) e^(i n ω t) +
  ∑_(n = -∞)^(-1) frac(a_(-n) + i b_(-n), 2) e^(i n ω t) \
  &= ∑_(-∞)^∞ C_n e^(i n ω t)
$
...
$
  f(x) = a_0 / 2 + ∑_(n=1)^∞ ( a_n cos (frac(2π n, T) x) + b_n sin (frac(2π n, T) x) ), C ∈ ℝ
$
