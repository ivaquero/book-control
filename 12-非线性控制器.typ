...
$
  u = dot(x)_d + k e + u_("aux") = dot(x)_d + k e + ρ|e| / e
$
...
- $|a| ≤ |macron(a)|$
- $|f(x)| = |a| x^2 ≤ |macron(a)| x^2 < |a|(x^2 + 0.1)$

于是，可以设计

$
  u = k e + dot(x)_d + |macron(a)|(x^2 + 0.1) |e| / e
$
...
令$u_("aux2") = 1 / ɛ⋅ρ^2 e$，且$V = 1 / 2 e^2$
...
对上述问题，采用高频鲁棒控制，平滑滑膜控制。令$u_("aux3") = frac(ρ^2 e, ρ|e| + ɛ)$，且$V = 1 / 2 e^2$
...
#figure(
  table(
    ...
    [Name], [$u_("aux")$], [$ɛ$], [稳态误差], [收敛速度], [瞬态输入], [稳态输入],
