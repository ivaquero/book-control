...
MPC 问题的一个难点就是最小化代价函数的计算。目前的思路是将@costd 转化为二次型，这里令
...
为将@costd2 化为@cost 形式，即只有一个变量的形式，做如下代换

$
  cases(
  𝒙_((k|k)) = 𝒙_k,
  𝒙_((k+1|k)) = 𝑨 𝒙_k + 𝑩 𝒖_(k|k),
  𝒙_((k+2|k)) = 𝑨^2 𝒙_k + 𝑨 𝑩 𝒖_(k|k) + 𝑩 𝒖_(k+1|k),
  …,
