...
$ J = sum_k^(N-1) (𝒆^⊤_k 𝑸 𝒆_k + 𝒖^⊤_k 𝑹 𝒖_k) + 𝒆^⊤_N 𝑭 𝒆_N $ <cost-mpc>
...
$
  min J = sum_(i=k)^(N-1) ( underbrace(𝒙^⊤_(k+i|k) 𝑸 𝒙_(k+i|k), "误差的加权和") + underbrace(𝒖^⊤_(k+i|k) 𝑹 𝒖_(k+i|k), "输入的加权和") ) + underbrace(𝒙^⊤_(k+N) 𝑭 𝒙_(k+N), "终端误差")
$ <cost-mpc2>
